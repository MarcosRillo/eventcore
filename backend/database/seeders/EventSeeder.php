...
class EventSeeder extends Seeder
{
    ...
    private function seedDemoEvents(): void
    {
        ...
        $demoEvents = [
            ...
            ['Festival de Jazz del NOA', 'Tres días de jazz con bandas nacionales e internacionales en el Teatro San Martín y espacios al aire libre.', 38, 20, 40, 23, $festivalesType, 'Festival de Música', $themeMusical, $frequencyAnual, $rotationRotativo, $originNational, $multiSedeFormat, 2, 'Escenario Teatro San Martín'],
            ...
            ['Competencia de Mountain Bike Yungas', 'Circuito de mountain bike por las Yungas tucumanas, 45km de senderos naturales.', 48, 7, 48, 16, $deportesType, 'Competencia', $themeDeportivo, $frequencyAnual, $rotationFijo, $originLocal, $sedeUnicaFormat, 2, 'Sendero de las Yungas'],
            ...
            // === CULTURA (5) ===
            ['Exposición Pintores del NOA', 'Muestra colectiva de artistas plásticos del Noroeste Argentino en el Museo Timoteo Navarro.', 32, 10, 50, 20, $culturaType, 'Exposición de Arte', $themeCultural, $frequencyAnual, $rotationFijo, $originNational, $sedeUnicaFormat, 1, 'Sala principal del museo'],
            ...
            ['Concierto Sinfónica de Tucumán', 'Programa especial con obras de Ginastera, Piazzolla y Guastavino interpretado por la Orquesta Sinfónica.', 41, 20, 41, 22, $culturaType, 'Concierto', $themeMusical, $frequencyMensual, $rotationFijo, $originLocal, $sedeUnicaFormat, 0, 'Teatro San Martín - Sala Principal'],
            ...
            ['Avistaje de Aves en Reserva Horco Molle', 'Excursión de avistaje con guías ornitólogos en la Reserva Natural de Horco Molle, binoculares incluidos.', 49, 6, 49, 12, $turismoType, 'Tour Guiado', $themeDeportivo, $frequencyMensual, $rotationFijo, $originLocal, $sedeUnicaFormat, 0, 'Entrada Reserva Horco Molle'],
            ...
            // === FERIAS (5) ===
            ['Feria de Artesanías del Norte', 'Artesanos de Tucumán, Salta y Jujuy exhiben y venden sus creaciones en madera, cuero y tejidos.', 36, 10, 37, 20, $feriasType, 'Feria Artesanal', $themeCultural, $frequencyAnual, $rotationRotativo, $originNational, $sedeUnicaFormat, 2, 'Paseo de artesanos'],
            ...
            ['Feria del Libro Tucumán', 'Edición anual de la feria del libro con presentaciones de autores locales, talleres y actividades infantiles.', 46, 10, 52, 20, $feriasType, 'Feria del Libro', $themeAcademico, $frequencyAnual, $rotationFijo, $originLocal, $sedeUnicaFormat, 1, 'Centro Cultural Virla'],
            ...
            ['Seminario de Gastronomía Sustentable', 'Seminario sobre cocina con productos locales, reducción de desperdicios y cadenas de valor cortas.', 43, 10, 43, 18, $conferenciasType, 'Seminario', $themeGastronomico, $frequencyUnico, $rotationFijo, $originLocal, $sedeUnicaFormat, 2, 'Universidad Nacional de Tucumán'],
            ...
            ['Charla: Historia Viva de Tucumán', 'Ciclo de charlas sobre la historia de Tucumán desde la independencia hasta la actualidad.', 52, 19, 52, 21, $conferenciasType, 'Charla', $themeAcademico, $frequencyMensual, $rotationFijo, $originLocal, $sedeUnicaFormat, 1, 'Casa Histórica de la Independencia'],
