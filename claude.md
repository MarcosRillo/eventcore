...
- **Reset & Seed DB:** `docker compose exec backend php artisan migrate:fresh --seed` (⚠️ USAR SOLO BAJO PETICIÓN EXPLÍCITA)
...
- **Ghostwriter Mode:** NUNCA añadas footers tipo "Co-Authored-By", "Generated by", ni ninguna atribución a la IA en los mensajes de commit. El autor es siempre el usuario.
