...
/**
 * Event Subtypes Page Container
 * Admin page for managing subtypes of a specific event type
 * This component is "dumb" - it only renders data from the useEventSubtypeManager hook
 */
...
interface EventSubtypesPageContainerProps {
  eventTypeId: number
}

export function EventSubtypesPageContainer({ eventTypeId }: EventSubtypesPageContainerProps) {
