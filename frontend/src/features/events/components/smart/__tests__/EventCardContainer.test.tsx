...
describe('EventCardContainer', () => {
  ...
  const baseEvent: Event = {
    ...
    is_featured: false,
    locations: [],
    location: { id: 1, name: 'Teatro', address: 'Test 123', city: 'CABA', country: 'Argentina', is_active: true, entity_id: 1, created_at: '2025-01-01T00:00:00Z', updated_at: '2025-01-01T00:00:00Z' },
