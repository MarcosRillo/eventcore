/**
 * StatsBar - Dumb Component (Internal Calendar)
 *
 * Displays internal calendar statistics for approved events.
 * Shows stats for approved_internal + published events.
 *
...
export function StatsBar({ stats, loading }: StatsBarProps) {
  ...
  // No stats - return null (component hidden)
  if (!stats) {
    return null
  }
  ...
  const statItems = [
    ...
    },
    {
      ...
      label: 'Tipos de eventos activos',
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
  ...
  return (
    <div
      ...
      role="region"
      aria-label="Estadísticas del calendario interno"
    >
      <div className="container mx-auto px-4 py-3">
