...
const TextAreaField = ({
  ...
  <div>
    ...
    <textarea
      ...
      maxLength={maxLength}
      rows={4}
      className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 resize-none ${
        error ? 'border-red-500' : 'border-gray-300'
      }`}
      data-testid={`input-${id}`}
    />
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-lg" data-testid="registration-form">
      <div className="p-6 border-b">
        <h1 className="text-2xl font-bold text-gray-900">Solicitar Cuenta de Organizador</h1>
      ...
      {serverError && (
        <div className="mx-6 mt-6 p-4 bg-red-50 border border-red-200 rounded-md flex items-start" data-testid="server-error">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-8">
        ...
        <div>
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Motivación</h2>
          </div>
          <TextAreaField
            id="motivation"
